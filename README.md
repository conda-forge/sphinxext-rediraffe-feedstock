...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sphinxext-rediraffe-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11879&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sphinxext-rediraffe-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sphinxext-rediraffe` can be installed with:

```
conda install sphinxext-rediraffe
```

It is possible to list all of the versions of `sphinxext-rediraffe` available on your platform with:
